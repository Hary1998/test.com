...
<!--Script Save as, Table, Search...-->
    ...
    <tbody> 
    <div id="button">
        <br><a href="form1.php" class="btn btn-info btn-xs"><i clas="glyphicon glyphicon-import"></i> Import Data </a> </br>
    </div>
    <br>
    <div class="table-responsive">
        <form method="post" action="hapus1.php" id="form-delete">
          ...
          <tr> 
           ...
           <?php
             ...
             // Buat query untuk menampilkan semua data siswa
                $sql = $pdo->prepare("SELECT * FROM db_topik ORDER BY id DESC");
